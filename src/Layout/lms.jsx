...
import LTImg1 from '../assets/lt-img3.png';
import LTImg2 from '../assets/lt-img2.png';
import LTImg3 from '../assets/lt-img1.png';

const LMS = () => {
    return (
        <>
            <div className="relative w-full h-[590px] bg-[url('/src/assets/lms-bg.jpg')] bg-cover bg-top flex items-center justify-center">
                {/* Overlay */}
                ...
                <div className="relative z-10 text-white  text-center flex flex-col items-center justify-end h-full">
                    <div className="bg-[#003A70CC] flex flex-col items-center justify-center p-8">
                        ...
                        <h1 className="text-4xl font-bold">Learning Management System (LMS)</h1>
            ...
            <div className="bg-[#F0F3F7] py-10">
                <div className="w-[90%] mx-auto my-10">
                    <div className='w-2/3 flex flex-col gap-[21px]'>
                        <div className='flex items-end'>
                            <h2 className='text-[#151515F] font-semibold text-[25px] md:text-[40px]'>Team Leads</h2>
                            <img className='hidden md:block' src={Line} alt="" />
                        </div>
                    </div>
                    <div class="flex flex-col flex-wrap my-10 gap-10">
                        <div className="bg-white flex items-center p-14 w-3/4 gap-10">
                            <img className="w-[129px] h-[129px]" src={LTImg1} alt="" />
                            <div className="flex flex-col gap-4">
                                <h2 className="text-[#151515] font-bold text-lg">Dr. Kevin Martin</h2>
                                <span className="text-[#003A70] font-semibold text-lg">Researcher & Professor</span>
                                <p>
                        ...
                        <div className="flex justify-end">
                            <div className="bg-white flex items-center p-14 w-3/4 gap-10">
                                <img className="w-[129px] h-[129px]" src={LTImg2} alt="" />
                                <div className="flex flex-col gap-4">
                                    <h2 className="text-[#151515] font-bold text-lg">Dr. Kevin Martin</h2>
                                    <span className="text-[#003A70] font-semibold text-lg">Researcher & Professor</span>
                                    <p>
                        ...
                        <div className="bg-white flex items-center p-14 w-3/4 gap-10">
                            <img className="w-[129px] h-[129px]" src={LTImg3} alt="" />
                            <div className="flex flex-col gap-4">
                                <h2 className="text-[#151515] font-bold text-lg">Dr. Kevin Martin</h2>
                                <span className="text-[#003A70] font-semibold text-lg">Researcher & Professor</span>
                                <p>
